    ...
    <main className="pt-16 md:px-6">
      ...
      <div className="page-w-8">
        ...
        <ul className="">
          ...
          <li className="list-circle">
            ...
            read across all devices. Stick to simple, <b>sans-serif fonts</b>{" "}
            that convey professionalism and trustworthiness.
          </li>
          <li className="list-circle">
      ...
      <div className="page-w-8">
        ...
        <p>
          ...
          ensure it is both attractive and functional.{" "}
          <b>Here’s how we achieve this:</b>
        </p>
        <ul className="">
          <li className="list-circle">
      ...
      <div className="page-w-8">
        <h2>Why Does a Website Need to Be Responsive?</h2>
        <p>
