  ...
  return (
    <main className="pt-16 md:px-6">
      ...
      <div className="page-w-8">
        <h2>What is Custom Code for Healthcare Websites?</h2>
        <p>
        ...
        <ul className="list-image-[url(/icons/check.png)]">
          <li>
            <b>Tailored Design:</b> Your website will look exactly the way you
            envision it, with no compromises. Every element, from layout to
            color scheme, is designed to reflect your brand.
          </li>
          <li>
          ...
          <li>
            ...
            avoiding common security issues found in generic templates or
            plugins, which are often targeted by hackers.
          </li>
          <li>
            <b>Scalability:</b> As your practice grows, your website can easily
            adapt. Custom code allows for seamless updates and the addition of
            new features without the limitations of pre-built systems.
          </li>
        </ul>
      </div>
      <div className="page-w-8">
        <h2>How Can a Custom Website Help Your Medical Practice?</h2>
        <p>
          A custom website isn’t just about looking good—it’s about enhancing
      ...
      <div className="page-w-8">
        <h2>Tech We Use for Building Your Medical Website</h2>
        <p>
          At Health Web Experts, we’re committed to using the best and latest
          technologies to build your healthcare website. Depending on the
          complexity and needs of your site, we choose the most suitable tools
      ...
      <div className="page-w-8">
        <h2>Why We Don’t Like WordPress or Any Page Builder</h2>
        <p>
          While WordPress and page builders are popular options for many
          websites, they’re not always the best choice for healthcare providers.
        ...
        <ul className="list-image-[url(/icons/check.png)]">
          <li>
            ...
            This can lead to long load times, frustrating your patients.
          </li>
          <li>
            <b>Security Vulnerabilities:</b> WordPress is a common target for
            hackers, especially if plugins and themes aren’t regularly updated.
            Custom-coded websites are less prone to such attacks.
          </li>
          <li>
            <b>Limited Customization:</b> While WordPress offers a lot of
            plugins, they can only take you so far. Custom code allows for
            complete freedom in design and functionality, without being
            restricted by the limitations of a theme or plugin.
          </li>
          <li>
            <b>Unnecessary Bloat:</b> WordPress sites often come with a lot of
            unnecessary code, which can slow down your site and make it harder
            to maintain. Custom code is leaner, faster, and easier to manage.
          </li>
          <li>
            <b>Maintenance Challenges:</b> Managing a WordPress site often
            requires frequent updates, plugin management, and troubleshooting.
            With custom code, you have a cleaner, more streamlined site that’s
            easier to maintain.
          </li>
        </ul>
      </div>
      <div className="page-w-8">
        <h2>WordPress vs. Custom Code</h2>
        <p>
          When it comes to building a website for your medical practice, the
